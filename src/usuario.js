  ...
  app.innerHTML = `
    <div>
      ...
      <label>Fecha de nacimiento: 
        <input type="date" id="fechaNacimiento" value="${usuario.fecha_nacimiento}" />
      </label><br/>
      <label>Teléfono: <input id="telefono" value="${usuario.telefono}" /></label><br/>
      <label>Rol: ${usuario.rol}</label><br/>
      ...
      ${usuario.roll === "admin" ? `<button class="c-nav-item"
id="btn-administrador">Administrador</button>` : ""}
      <br/><br/><br/><br/><br/>
    </div>
  `;
